...
# │  BOT TOKEN  add karo.   ││
# └──────────────────────────────────────────────────────────────┘
BOT_TOKEN_HARDCODED = "8326544735:AAHIsJspK17DOMKIfFztUQ33O1udqY27vHo"   # ← ADD BOT TOKEN
TOKEN = (
...
try:
    OWNER_ID = int(os.environ.get("OWNER_ID", "6408034985"))
...
BRAND       = "Trolex нoѕтιηg ＲΒOT"
BRAND_VER   = "v2.1"
BRAND_TAG   = f"{BRAND} {BRAND_VER}"
SUPPORT_USR = "@trolex00"
UPDATE_CH   = "https://t.me/+pz9tLo3_XSZhODFl"
...
REQUIRED_GROUPS = [
    {"id": -1002133681878, "link": "https://t.me/trolexgroup0077", "name": "Group 1"},
    {"id": -1002133681878, "link": "https://t.me/trolexgroup0077",     "name": "Group 2"},
]
...
def render_referral(call: types.CallbackQuery) -> None:
    ...
    try:
        ...
        link = f"http://t.me/Trolexxro_bot?start={uid}"
    cap = (
        f"<b>{G['users']} {sc('Referral')}</b>\n"
        f"{G['div_eq']}\n"
        f"{bullet('Your link', link)}\n"
